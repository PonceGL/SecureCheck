...
type SupportedLanguage = 'en' | 'es' | 'fr' | 'de' | 'it' | 'pt' | 'ru' | 'zh' | 'ja' | 'ko';
...
const translations = {
  en: {
    ...
    secureCheckDescription: "SecureCheck is an advanced URL security analyzer that helps protect users from malicious websites, data theft, and privacy violations. Our comprehensive analysis includes malware detection, phishing protection, privacy analysis, and SSL/TLS verification.",
    whyChooseSecureCheck: "Why choose SecureCheck?",
    whyChooseDescription: "• Real-time threat detection\n• Comprehensive privacy analysis\n• Easy-to-understand reports\n• Advanced SSL/TLS verification\n• No registration required",
    whatIsMaliciousLink: "What is a malicious link?",
    maliciousLinkDescription: "A malicious link is a URL that directs users to harmful websites designed to steal personal information, install malware, or perform other malicious activities. These links can appear in emails, messages, or websites and may look legitimate.",
    whyCheckLinks: "Why should you check links constantly?",
    whyCheckDescription: "Regular link checking is essential because:\n• Cyberthreats evolve constantly\n• New malicious websites appear daily\n• Legitimate websites can be compromised\n• Early detection prevents data theft\n• Protects your devices and personal information"
  },
  es: {
    ...
    explainDisagreement: "Por favor explique por qué no está de acuerdo con este análisis:",
    ...
    secureCheckDescription: "SecureCheck es un analizador avanzado de seguridad de URL que ayuda a proteger a los usuarios de sitios web maliciosos, robo de datos y violaciones de privacidad.",
    whyChooseSecureCheck: "¿Por qué elegir SecureCheck?",
    whyChooseDescription: "• Detección de amenazas en tiempo real\n• Análisis integral de privacidad\n• Reportes fáciles de entender\n• Verificación avanzada SSL/TLS\n• No requiere registro",
    whatIsMaliciousLink: "¿Qué es un enlace malicioso?",
    maliciousLinkDescription: "Un enlace malicioso es una URL que dirige a los usuarios a sitios web dañinos diseñados para robar información personal, instalar malware o realizar otras actividades maliciosas.",
    whyCheckLinks: "¿Por qué debe verificar enlaces constantemente?",
    whyCheckDescription: "La verificación regular de enlaces es esencial porque:\n• Las amenazas cibernéticas evolucionan constantemente\n• Aparecen nuevos sitios web maliciosos diariamente\n• Los sitios web legítimos pueden ser comprometidos"
  }
};
